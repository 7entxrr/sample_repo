      ...
      <main className="pt-16">
        <section className="px-4 py-20 max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">2. Service Issues</h2>
              <p className="text-zinc-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">3. Cancellation</h2>
              <p className="text-zinc-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">4. Billing Errors</h2>
              <p className="text-zinc-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4">6. Exceptions</h2>
              <p className="text-zinc-300 leading-relaxed">
